document.addEventListener("DOMContentLoaded", function () {
    ...
    new Choices("#choices-single-no-search", {
        ...
        label: "Label Six",
        selected: !0
    }], "value", "label", !1), new Choices("#choices-single-no-sorting", {
        shouldSort: !1
    }), new Choices("#choices-multiple-remove-button", {
        removeItemButton: !0
    }), new Choices(document.getElementById("choices-multiple-groups")), new Choices(document.getElementById("choices-text-remove-button"), {
        delimiter: ",",
        editItems: !0,
        maxItemCount: 5,
        removeItemButton: !0
